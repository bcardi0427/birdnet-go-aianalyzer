...
Setting (**node locale**) controls which translations are used for common names of birds in output. Valid locales are documented here [Supported Locales](https://github.com/tphakala/birdnet-go/wiki/BirdNET%E2%80%90Go-Guide#supported-locales-for-species-labels)
