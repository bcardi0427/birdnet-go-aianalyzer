...
export type TranslationKey =
  ...
  | 'notifications.content.settings.reconfiguringWeather'
  ...
  | 'aiAnalysis.loading'
  | 'aiAnalysis.empty'
  | 'aiAnalysis.refreshedAt' // params: time
  | 'aiAnalysis.actions.refresh'
  | 'aiAnalysis.actions.settings'
  | 'aiAnalysis.errors.loadFailed'
  | 'settings.title'
  | 'settings.loading'
  ...
  | 'settings.ai.saved'
  | 'settings.ai.configuration.title'
  | 'settings.ai.configuration.description'
  | 'settings.ai.fields.enabled'
  | 'settings.ai.fields.enabledHelp'
  | 'settings.ai.fields.apiKey'
  | 'settings.ai.fields.apiKeyHelp'
  | 'settings.ai.fields.model'
  | 'settings.ai.fields.modelPlaceholder'
  | 'settings.ai.fields.fallbackModel'
  | 'settings.ai.fields.fallbackModelHelp'
  | 'settings.ai.fields.cacheHours'
  | 'settings.ai.fields.cacheHoursHelp'
  | 'settings.ai.fields.systemPrompt'
  | 'settings.ai.fields.systemPromptPlaceholder'
  | 'settings.ai.fields.systemPromptHelp'
  | 'settings.ai.actions.refreshModels'
  | 'settings.ai.errors.loadFailed'
  | 'settings.ai.errors.saveFailed'
  | 'settings.ai.errors.modelsFailed'
  | 'settings.ai.errors.apiKeyRequiredForModels'
...
export type TranslationParams = {
  ...
  'aiAnalysis.refreshedAt': { time: string | number };
  ...
  'analysis.rangeFilter.status.geomodelInfo': { version: string | number; species: string | number };
