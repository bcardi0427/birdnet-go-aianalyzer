...
- [LLM Provider Expansion Plan for AI Analyzer](#llm-provider-expansion-plan-for-ai-analyzer)
  ...
  - [Proposed Configuration Shape](#proposed-configuration-shape)
    - [Provider IDs](#provider-ids)
    - [Provider Defaults](#provider-defaults)
  - [Implementation Phases](#implementation-phases)
    - [Phase 1: Add Provider-Neutral Settings](#phase-1-add-provider-neutral-settings)
    - [Phase 2: Update Validation and Normalization](#phase-2-update-validation-and-normalization)
    - [Phase 3: Introduce an LLM Provider Abstraction](#phase-3-introduce-an-llm-provider-abstraction)
    - [Phase 4: Implement Provider Adapters](#phase-4-implement-provider-adapters)
      - [Gemini Adapter](#gemini-adapter)
      - [OpenAI Adapter](#openai-adapter)
      - [OpenRouter Adapter](#openrouter-adapter)
      - [OpenAI-Compatible Adapter](#openai-compatible-adapter)
      - [Ollama Adapter](#ollama-adapter)
      - [Anthropic Adapter](#anthropic-adapter)
    - [Phase 5: Refactor Report Generation](#phase-5-refactor-report-generation)
    - [Phase 6: Update Cache Compatibility](#phase-6-update-cache-compatibility)
    - [Phase 7: Update API Routes](#phase-7-update-api-routes)
    - [Phase 8: Update Frontend Settings UI](#phase-8-update-frontend-settings-ui)
    - [Phase 9: Testing Plan](#phase-9-testing-plan)
      - [Backend Config Tests](#backend-config-tests)
      - [Backend API Tests](#backend-api-tests)
      - [Report Service Tests](#report-service-tests)
      - [Provider Adapter Tests](#provider-adapter-tests)
      - [Frontend Tests](#frontend-tests)
  - [Documentation Plan](#documentation-plan)
    - [Example: Gemini](#example-gemini)
    - [Example: OpenAI](#example-openai)
    - [Example: OpenRouter](#example-openrouter)
    - [Example: OpenAI-Compatible](#example-openai-compatible)
  ...
  - [Recommended First Implementation Scope](#recommended-first-implementation-scope)
